...
const TeamField = ({ data, dataLength }) => {
    ...
    return <div className={styles.formation_view_wrapper}>
        ...
        <div className={styles.player_info}>
            {
                dataLength === 11 && <div className={styles.player_img_sect}>
            ...
            {
                dataLength === 11 && <div className={styles.player_info_sect2}>
            ...
            <div className={styles.player_info_sect3}>
                ...
                {
                    dataLength === 11 && <><PlayerInfo2 info_name="Appearances" info_value={playerDetail?.appearances} />
